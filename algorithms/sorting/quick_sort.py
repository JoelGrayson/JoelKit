...
def quick_sort_not_in_place(lst): #-> sorted list
    ...
    sorted_left = quick_sort_not_in_place(left)
    sorted_right = quick_sort_not_in_place(right)
...
if __name__ == '__main__':
    test_sort(quick_sort_not_in_place, in_place=False)
