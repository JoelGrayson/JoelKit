...
export default function Queue() {
    return <>
        <Toggle title="Queue">
            ...
            <p>Queue supports enqueue, dequeue, and peek. It&apos;s a first in first out (FIFO) data structure.</p>
...
const queueCppH = `template <typename T>
class Queue {
private:
    T* elems_;
...
const queueCpp = `#include "queue.h"
